...
function MainSearchForm({ handleSearchForm, searchInput, handleSearchValueChange, searchedUser, isOpen, close}){
        ...
        <>
            <form onSubmit={handleSearchForm}>
                <div className="form-control">
                    ...
                    <input type="text" placeholder="Find a user" value={searchInput} onChange={handleSearchValueChange} />
                </div>
            </form>
